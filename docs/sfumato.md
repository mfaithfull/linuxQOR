...
Software is an art form, a great one, and we can apply an analogue of Leonardo's techinique that produced some of the greatest paintings of all time.
By the use of many thin layers we remove the barriers to the eye and the understanding.
