...
This is great for interceptors, error handlers, loggers and anything that you might pass into every function but you don't want to put it in all those function signatures.
