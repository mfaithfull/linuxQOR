...
All the customisation is still there, if you need it. e.g.
RunWorkflow<CustomWorkflow>(
    [](ref_of<CustomWorkflow>::type workflow)
    {
        //This customisation is called before the workflow is run.
    }
);
*/
