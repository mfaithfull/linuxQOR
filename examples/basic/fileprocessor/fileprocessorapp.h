...
#ifndef QOR_PP_H_EXAMPLES_FILEPROCESSOR_APP
#define QOR_PP_H_EXAMPLES_FILEPROCESSOR_APP

#include "src/framework/application/application.h"
#include "src/components/framework/optionparser/ioptionable.h"

class FileProcessorApp : public qor::framework::Application, public qor::components::optparser::IOptionable
{
public:

        FileProcessorApp() = default;
        virtual ~FileProcessorApp() = default;
...
namespace qor{
    qor_pp_declare_instancer_of(FileProcessorApp, SingletonInstancer);
}

#endif//QOR_PP_H_EXAMPLES_FILEPROCESSOR_APP