...
#ifndef QOR_PP_H_EXAMPLES_RESOUCED_APP
#define QOR_PP_H_EXAMPLES_RESOUCED_APP
...
public:
    ...
    constexpr static const char* Name = "Resourced App";

    ResourcedApp() = default;
    virtual ~ResourcedApp() = default;
...
namespace qor{ 
    qor_pp_declare_instancer_of(ResourcedApp, SingletonInstancer);
    qor_pp_declare_sync_of(ResourcedApp, RecursiveMutex);
}
