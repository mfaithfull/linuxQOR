...
#include "src/platform/os/windows/ui/gui/gui.h"
#include "resource.h"
...
void MainWindowFocusController::OnSetFocus(qor::platform::win::Window& window, qor::platform::win::Window& otherWindow)
{
    if (m_view->hwndEdit)
    {
...
void MainWindowNonClientRenderController::OnNCSize(qor::platform::win::Window& window, long long& lResult, unsigned long long wParam, long long lParam)
{
    m_view->UpdateLayout();
...
void MainWindowMenuController::OnInitMenuPopup(qor::platform::win::Window& window, qor::platform::win::Menu& menu, unsigned short wPos, bool bWindowMenu)
{
...
void MainWindowDragAndDropController::OnDropFiles(qor::platform::win::Window& window, void* drop)
{
...
long long MainWindowInstanceController::OnDestroy(qor::platform::win::Window& window, unsigned int uMsg, unsigned long long wParam, long long lParam)
{
    GUI::Quit(0);
    return 0;
}

void MainWindowInstanceController::OnClose(qor::platform::win::Window& window)
{
    if (m_view->PromptSaveChanges()) 
    {
        window.Destroy();
...
void MainWindowInstanceController::OnCommand(qor::platform::win::Window& Window, unsigned short wNotify, unsigned short wID, long long lParam)
{
...
void MainWindowInstanceController::HandleCommand(qor::platform::win::Window& Window, unsigned short wNotify, unsigned short wID, long long lParam) 
{
    switch(wNotify) 
    {
    case IDM_FILE_NEW:
