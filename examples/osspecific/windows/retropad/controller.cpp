...
using namespace qor::platform::win::gui;
using namespace qor::platform::win::gui::view;

RetroPadTopLevelWindowController::RetroPadTopLevelWindowController() : qor::platform::win::gui::view::TopLevelWindowHandler()
{
...
long RetroPadTopLevelWindowController::OnCreate(qor::platform::win::Window& window, qor::platform::win::gui::view::CreateStruct* pCreateStruct)
{
...
LRESULT RetroPadController::MainWindowHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    if (msg == m_findMsg) 
    {
        m_view->HandleFindReplace((qor::platform::win::FindReplace*)lParam);
        return 0;
    }
