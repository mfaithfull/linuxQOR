    ...
    m_logHandler(log::Level::Debug)
{
    ...
    connect->Enter = [this]()->void
    {
        ...
        m_connector = new_ref<qor::io::network::components::SocketConnector>();
        m_requestPipeline = new_ref<RequestPipeline>(m_connector);
        m_responsePipeline = new_ref<ResponsePipeline>(m_connector);

        if( m_connector->ConnectToAddress("localhost", 12345, "127.0.0.1", qor::io::network::sockets::eAddressFamily::AF_INet, 0, false, false) )
        {
