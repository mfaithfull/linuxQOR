        ...
        make_runable(
            ...
            []()->int
            {
                auto xclient = AppBuilder().TheApplication(qor_shared)->GetRole(qor_shared)->GetFeature<qor::platform::lin::XClient>();
                {
                    ...
                    qor::platform::lin::x::VisualInfoQuery visualInfoQuery;
                    ...
                    {                        
                        ...
                        qor::platform::lin::x::FontInfoHolder f = defaultDisplay->ListFontsWithInfo("*", 200, vecNames);
                    }
                    ...
                    qor::platform::lin::x::WindowChangeQuery windowChangeQuery;
                    ...
                    qor::platform::lin::x::SetWindowAttributesQuery windowSetAttribs;
                    windowSetAttribs.SetSaveUnder(1);
                    windowSetAttribs.SetBitGravity(qor::platform::lin::x::Window::NorthWestGravity);
                    ...
                    qor::platform::lin::x::MotifWmHints mhints = {0};
                    mhints.flags = MWM_HINTS_DECORATIONS;
                    mhints.decorations = 0;
                    //toplevelWindow->ChangeProperty(motifWMHintsProperty, motifWMHintsProperty, 32, qor::platform::lin::x::Window::PropModeReplace, (unsigned char*)(&mhints), sizeof(mhints)/sizeof(long));
                    ...
                    qor::platform::lin::x::WMSizeHints normalHints = toplevelWindow->GetNormalHints(validBitsOfReturn, status);
                    ...
                    for(unsigned long prop : atoms)
                    {
                        ...
                        toplevelWindow->GetProperty(prop, 0, 1, 0, qor::platform::lin::x::Window::AnyPropertyType, &actualType, &actualFormat, &itemsReturned, &bytesUnread, &data);
                    ...
                    toplevelWindow->SelectInput( qor::platform::lin::x::KeyPressMask | qor::platform::lin::x::ExposureMask | qor::platform::lin::x::StructureNotifyMask);
                    ...
                    while(!quit)
                    {
                        ...
                        while(
                            defaultDisplay->ProcessEvent(
                                [&defaultDisplay, &quit](int type) -> qor::platform::lin::x::eventHandler
                                {
                                    switch(type)
                                    {
                                    case qor::platform::lin::x::ClientMessageType:
                                        return [&defaultDisplay, &quit](qor::platform::lin::x::Event& event) -> int
                                        {
                                    ...
                                    case qor::platform::lin::x::KeyPressType:
                                        return [&defaultDisplay, &quit](qor::platform::lin::x::Event& event) -> int
                                        {
                                            if (defaultDisplay->LookupKeySymbol(reinterpret_cast<qor::platform::lin::x::KeyEvent&>(event), 0) == qor::platform::lin::x::XK_Escape)
                                            {
                                                quit = true;
                                            }
                                            return 0;
                                    ...
                                    default:
                                        return [](qor::platform::lin::x::Event& event) -> int
                                        {
                                            return 0;
                                        };
                                    }
