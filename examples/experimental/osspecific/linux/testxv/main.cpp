...
#include "src/platform/os/linux/ui/x/xlib/screen.h"
#include "src/platform/os/linux/ui/x/xlib/window.h"
#include "src/platform/os/linux/ui/x/xlib/font.h"
#include "src/platform/os/linux/ui/x/xlib/colourmap.h"
#include "src/platform/os/linux/ui/x/xlib/event.h"
#include "src/platform/os/linux/ui/x/xvideo/video.h"
#include "src/platform/os/linux/ui/x/xvideo/adaptorinfo.h"

using namespace std;
using namespace qor::platform::lin::x;
...
int main( int argc, char *argv[] )
{
    ...
    testxvApp->SetRole<Role>(
        [](ref_of<IRole>::type role)
        {
            ...
            role->AddFeature<qor::platform::lin::XClient>();
        }
    );
    ...
    (
        make_runable(
            ...
            []()->int
            {
                ...
                auto xclient = AppBuilder().TheApplication(qor_shared)->GetRole(qor_shared)->GetFeature<qor::platform::lin::XClient>();
