...
RequestPipeline::RequestPipeline(ref_of<qor::io::network::components::SocketConnector>::type connector) : m_socketConnector(connector)
{
    ...
    m_source.SetSink(&m_socketSink);
    SetSource(&m_source);
    SetSink(&m_socketSink);
    SetFlowMode(FlowMode::Push);
}
