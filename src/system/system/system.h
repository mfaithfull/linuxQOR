...
#ifndef QOR_PP_H_SYSTEM_SYSTEM
#define QOR_PP_H_SYSTEM_SYSTEM
...
/*The System class represents the OS at runtime, it's capabilities services, 
...
namespace qor{ namespace system{
    ...
    class qor_pp_module_interface(QOR_SYSTEM) System
    {
    public:
    ...
    qor_pp_declare_instancer_of(system::System, SingletonInstancer);
    qor_pp_declare_sync_of(system::System, RecursiveMutex);

    qor_pp_module_interface(QOR_SYSTEM) ref_of<system::System>::type TheSystem();
}//qor

#endif//QOR_PP_H_SYSTEM_SYSTEM
