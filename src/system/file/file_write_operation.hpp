...
namespace cppcoro
{
	...
	class file_write_operation
		: public detail::win32_overlapped_operation<file_write_operation>
	{
	public:
		...
		file_write_operation(
			...
			const void* buffer,
			std::size_t byteCount) noexcept
			: detail::win32_overlapped_operation<file_write_operation>(fileOffset)
			, m_impl(fileHandle, buffer, byteCount)
		{}

	private:

		friend class detail::win32_overlapped_operation<file_write_operation>;
	...
	class file_write_operation_cancellable
		: public detail::win32_overlapped_operation_cancellable<file_write_operation_cancellable>
	{
	public:
		...
		file_write_operation_cancellable(
			...
			: detail::win32_overlapped_operation_cancellable<file_write_operation_cancellable>(fileOffset, std::move(ct))
			, m_impl(fileHandle, buffer, byteCount)
		{}

	private:

		friend class detail::win32_overlapped_operation_cancellable<file_write_operation_cancellable>;
