...
#ifndef QOR_PP_H_DATASTRUCTURES_FROZEN_BITS_ALGORITHMS
#define QOR_PP_H_DATASTRUCTURES_FROZEN_BITS_ALGORITHMS
...
#endif//QOR_PP_H_DATASTRUCTURES_FROZEN_BITS_ALGORITHMS
