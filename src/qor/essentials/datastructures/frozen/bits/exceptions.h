...
#ifndef QOR_PP_H_DATASTRUCTURES_FROZEN_BITS_EXCEPTIONS
#define QOR_PP_H_DATASTRUCTURES_FROZEN_BITS_EXCEPTIONS
...
#endif//QOR_PP_H_DATASTRUCTURES_FROZEN_BITS_EXCEPTIONS
