...
#ifndef QOR_PP_H_DATASTRUCTURES_FROZEN_ALGORITHM
#define QOR_PP_H_DATASTRUCTURES_FROZEN_ALGORITHM
...
namespace qor { namespace frozen {
    ...
    template <std::size_t size> class boyer_moore_searcher 
    {
        ...
        {
            // increment suffix length slen to the first mismatch or beginning of the word
...
#endif//QOR_PP_H_DATASTRUCTURES_FROZEN_ALGORITHM
