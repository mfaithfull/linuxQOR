...
#ifndef QOR_PP_H_DATASTRUCTURES_FROZEN_UNORDERED_MAP
#define QOR_PP_H_DATASTRUCTURES_FROZEN_UNORDERED_MAP
...
#endif//QOR_PP_H_DATASTRUCTURES_FROZEN_UNORDERED_MAP
