...
#ifndef QOR_PP_H_DATASTRUCTURES_FROZEN_SET
#define QOR_PP_H_DATASTRUCTURES_FROZEN_SET
...
namespace qor{ namespace frozen {
    ...
    public:
        ...
        constexpr set(std::initializer_list<Key>, Compare const &comp) : Compare{comp} {}
...
#endif//QOR_PP_H_DATASTRUCTURES_FROZEN_SET
