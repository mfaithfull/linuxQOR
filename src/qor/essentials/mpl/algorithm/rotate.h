...
#ifndef QOR_PP_H_MPL_ALGORITHM_ROTATE
#define QOR_PP_H_MPL_ALGORITHM_ROTATE
...
namespace qor { namespace mpl { namespace detail {
        ...
        {
            template <unsigned N, typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename... Ts>
            using f = typename rotate_impl<select_next_rotate_step(N - 8, sizeof...(Ts)), C>::template f<(N - 8), Ts..., T0, T1, T2, T3, T4, T5, T6, T7>;
        };
    ...
    //Moves N elements from the front of a list to the back of the list
    template <typename N, typename C = listify>
    struct rotate 
    {
        template <typename... Ts>
        using f = typename detail::rotate_impl<
                detail::select_next_rotate_step(detail::select_rotate_size(N::value, sizeof...(Ts)), 0),
...
#endif//QOR_PP_H_MPL_ALGORITHM_ROTATE