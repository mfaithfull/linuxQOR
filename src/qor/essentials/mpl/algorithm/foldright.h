...
#ifndef QOR_PP_H_MPL_ALGORITHM_FOLDRIGHT
#define QOR_PP_H_MPL_ALGORITHM_FOLDRIGHT
...
namespace qor { namespace mpl { namespace detail {
    ...
    //Fold right consideres the first element in the input pack the state, use
...
#endif//QOR_PP_H_MPL_ALGORITHM_FOLDRIGHT
