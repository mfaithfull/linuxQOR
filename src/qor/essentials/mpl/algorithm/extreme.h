...
#ifndef QOR_PP_H_MPL_ALGORITHM_EXTREME
#define QOR_PP_H_MPL_ALGORITHM_EXTREME
...
namespace qor { namespace mpl { namespace detail {
        ...
        {
            template <typename C, template <typename...> class Pred, typename Result, typename... Ts>
        ...
        {
            template <typename C, template <typename...> class Pred, typename T0, typename T1, typename... Ts>
            using f =
                    typename extreme_impl<(sizeof...(Ts) + 1)>::template f<C, Pred, Pred<T0, T1>, Ts...>;
        };
    ...
    struct extreme 
    {
        ...
        using f = typename detail::extreme_impl<detail::extreme_impl_select(sizeof...(Ts))>::template f<C, Pred::template f, Ts...>;
    };

}}//qor::mpl

#endif//QOR_PP_H_MPL_ALGORITHM_EXTREME
