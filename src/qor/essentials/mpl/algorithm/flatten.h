...
#ifndef QOR_PP_H_MPL_ALGORITHM_FLATTEN
#define QOR_PP_H_MPL_ALGORITHM_FLATTEN
...
namespace qor { namespace mpl { namespace detail {
    ...
    //Converts a tree or list of lists into one list containing the contents of all
...
#endif//QOR_PP_H_MPL_ALGORITHM_FLATTEN
