...
#ifndef QOR_PP_H_MPL_ALGORITHM_STABLESORT
#define QOR_PP_H_MPL_ALGORITHM_STABLESORT
...
namespace qor { namespace mpl { namespace eager { namespace detail {
            ...
            {
                template <template <typename...> class Comp, typename T>
                using f = typename push_bst_impl<Comp<T, Elem>::value>::template f<Comp, T, Elem, Left, Right>;
            };
            ...
            {
                using f = typename join_extents<typename flatten_bst<Left>::f, Elem, typename flatten_bst<Right>::f>::f;
            };
        ...
        using stable_sort = typename detail::flatten_bst<mpl::call<
                unpack<mpl::push_front<nothing, mpl::fold_left<detail::push_func<Comp>>>>, List>>::f;
    }//eager

    //Stable sorts a pack of elements
...
#endif//QOR_PP_H_MPL_ALGORITHM_STABLESORT