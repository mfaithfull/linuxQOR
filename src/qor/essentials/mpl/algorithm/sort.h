...
#ifndef QOR_PP_H_MPL_ALGORITHM_SORT
#define QOR_PP_H_MPL_ALGORITHM_SORT
...
namespace qor { namespace mpl { namespace detail {
        ...
        template <class... R, class T0, class T1, class... Ts, class U, class... Us, template <typename...> class Comp>
...
#endif//QOR_PP_H_MPL_ALGORITHM_SORT