...
#ifndef QOR_PP_H_MPL_ALGORITHM_FINDIF
#define QOR_PP_H_MPL_ALGORITHM_FINDIF
...
namespace qor { namespace mpl { namespace detail {
    ...
    //Finds the first element in a list for which a predicate holds
    ...
    struct find_if 
    {
        ...
        using f = typename detail::find_if_impl<detail::first_find(sizeof...(Ts)), FC, NFC>::template f<F::template f, Ts...>;
    };
...
#endif//QOR_PP_H_MPL_ALGORITHM_FINDIF