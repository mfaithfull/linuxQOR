...
#ifndef QOR_PP_H_MPL_SEQUENCE_DROP
#define QOR_PP_H_MPL_SEQUENCE_DROP
...
namespace qor { namespace mpl { namespace detail {
    ...
    struct drop 
    {
        ...
        using f = typename detail::drop_impl<detail::select_next_drop_step(N::value, sizeof...(Ts)), C>::template f<N::value, Ts...>;
    };
...
#endif//QOR_PP_H_MPL_SEQUENCE_DROP
