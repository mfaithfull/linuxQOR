...
#ifndef QOR_PP_H_REFLECTION_DETAIL_SIZEARRAY
#define QOR_PP_H_REFLECTION_DETAIL_SIZEARRAY
...
namespace qor_reflection { namespace detail {
    ...
    struct size_array 
    {                         // libc++ misses constexpr on operator[]
    ...
    {
        static_assert(I < N, "====================> QOR Reflection: Array index out of bounds");
        return a.data[I];
    }
