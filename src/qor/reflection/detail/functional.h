...
#ifndef QOR_PP_H_REFLECTION_DETAIL_FUNCTIONAL
#define QOR_PP_H_REFLECTION_DETAIL_FUNCTIONAL
...
namespace qor_reflection { namespace detail {
    ...
    template <typename T>
    auto compute_hash(const T& value, long /*priority*/) -> decltype(std::hash<T>()(value))
    {
    ...
    {
        static_assert(sizeof(T) && false, "====================> QOR Reflection: std::hash not specialized for type T");
        return 0;
    }
