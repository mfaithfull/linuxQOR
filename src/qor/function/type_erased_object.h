...
#ifndef QOR_PP_H_FUNCTION_TEF_TYPE_ERASED_OBJECT
#define QOR_PP_H_FUNCTION_TEF_TYPE_ERASED_OBJECT
...
#include "type_erased_object.hpp"

#endif  // QOR_PP_H_FUNCTION_TEF_TYPE_ERASED_OBJECT
