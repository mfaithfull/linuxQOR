...
namespace qor { namespace components { namespace json { namespace parser {
    ...
    array::array(Parser* parser) :
        Sequence(parser,
            new_ref<begin_array>(parser).AsRef<ParserState>(),
            new_ref<Sequence>(parser,
                ...
                new_ref<end_array>(parser).AsRef<ParserState>()
            ).AsRef<ParserState>(),
    ...
    void array::Prepare()
    {
        GetParser()->PushNode(new_ref<Array>().AsRef<Node>());
    }

    void array::Emit()
    {        
        std::vector<ref_of<Value>::type> values;
        ...
        while(node.IsNotNull() && node->GetToken() != m_token)
        {
            ...
            {
                std::cout << "Emitting an array: " << std::endl;
        ...
        if(node.IsNotNull())
        {
            ...
            {
                node.AsRef<Array>()->m_values.push_back(*it);
            }
