...
bool net::socket_disconnect_operation_impl::try_start(
...
void net::socket_disconnect_operation_impl::cancel(
	detail::win32_overlapped_operation_base& operation) noexcept
{
	(void)::CancelIoEx(
...
void net::socket_disconnect_operation_impl::get_result(
