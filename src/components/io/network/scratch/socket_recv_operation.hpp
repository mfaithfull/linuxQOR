...
namespace net
{
	...
	class socket_recv_operation
		: public detail::win32_overlapped_operation<socket_recv_operation>
	{
	public:
	...
	private:
		...
		friend class detail::win32_overlapped_operation<socket_recv_operation>;
	...
	class socket_recv_operation_cancellable
		: public detail::win32_overlapped_operation_cancellable<socket_recv_operation_cancellable>
	{
	public:
		...
		socket_recv_operation_cancellable(
			...
			: detail::win32_overlapped_operation_cancellable<socket_recv_operation_cancellable>(std::move(ct))
			, m_impl(s, buffer, byteCount)
		{}

	private:

		friend class detail::win32_overlapped_operation_cancellable<socket_recv_operation_cancellable>;
