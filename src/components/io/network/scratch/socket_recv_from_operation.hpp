...
namespace net
{
	...
	public:
		...
		std::tuple<std::size_t, ip_endpoint> get_result(
			detail::win32_overlapped_operation_base& operation);
	...
	class socket_recv_from_operation
		: public detail::win32_overlapped_operation<socket_recv_from_operation>
	{
	public:
	...
	private:
		...
		friend class detail::win32_overlapped_operation<socket_recv_from_operation>;
	...
	class socket_recv_from_operation_cancellable
		: public detail::win32_overlapped_operation_cancellable<socket_recv_from_operation_cancellable>
	{
	public:
		...
		socket_recv_from_operation_cancellable(
			...
			: detail::win32_overlapped_operation_cancellable<socket_recv_from_operation_cancellable>(std::move(ct))
			, m_impl(socket, buffer, byteCount)
		{}

	private:

		friend class detail::win32_overlapped_operation_cancellable<socket_recv_from_operation_cancellable>;
