...
namespace net
{
	...
	class socket_send_to_operation
		: public detail::win32_overlapped_operation<socket_send_to_operation>
	{
	public:
	...
	private:
		...
		friend class detail::win32_overlapped_operation<socket_send_to_operation>;
	...
	class socket_send_to_operation_cancellable
		: public detail::win32_overlapped_operation_cancellable<socket_send_to_operation_cancellable>
	{
	public:
		...
		socket_send_to_operation_cancellable(
			...
			: detail::win32_overlapped_operation_cancellable<socket_send_to_operation_cancellable>(std::move(ct))
			, m_impl(s, destination, buffer, byteCount)
		{}

	private:

		friend class detail::win32_overlapped_operation_cancellable<socket_send_to_operation_cancellable>;
