...
namespace cppcoro
{
	namespace net
	{
		...
		public:
			...
			void get_result(detail::win32_overlapped_operation_base& operation);
		...
		class socket_disconnect_operation
			: public detail::win32_overlapped_operation<socket_disconnect_operation>
		{
		public:
		...
		private:
			...
			friend class detail::win32_overlapped_operation<socket_disconnect_operation>;
		...
		class socket_disconnect_operation_cancellable
			: public detail::win32_overlapped_operation_cancellable<socket_disconnect_operation_cancellable>
		{
		public:

			socket_disconnect_operation_cancellable(socket& socket, CancellationToken&& ct) noexcept
				: detail::win32_overlapped_operation_cancellable<socket_disconnect_operation_cancellable>(std::move(ct))
				, m_impl(socket)
			{}

		private:

			friend class detail::win32_overlapped_operation_cancellable<socket_disconnect_operation_cancellable>;
