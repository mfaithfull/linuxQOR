...
namespace cppcoro
{
	namespace net
	{
		...
		class socket_connect_operation
			: public detail::win32_overlapped_operation<socket_connect_operation>
		{
		public:
		...
		private:
			...
			friend class detail::win32_overlapped_operation<socket_connect_operation>;
		...
		class socket_connect_operation_cancellable
			: public detail::win32_overlapped_operation_cancellable<socket_connect_operation_cancellable>
		{
		public:
			...
			socket_connect_operation_cancellable(
				...
				: detail::win32_overlapped_operation_cancellable<socket_connect_operation_cancellable>(std::move(ct))
				, m_impl(socket, remoteEndPoint)
			{}

		private:

			friend class detail::win32_overlapped_operation_cancellable<socket_connect_operation_cancellable>;
