...
namespace qor{ namespace io{ namespace network{ namespace components{
    ...
    public:
        ...
        virtual void SetAddressFamily(qor::io::network::sockets::eAddressFamily family);
    ...
    private:
        ...
        qor::io::network::sockets::eAddressFamily m_AddressFamily = qor::io::network::sockets::eAddressFamily::AF_Unspecified;
