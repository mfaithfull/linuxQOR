...
namespace qor{ namespace components{ namespace network{
    ...
    void SocketClient::Stop()
    {
        ...
        {
            m_Socket->Shutdown(qor::io::network::sockets::eShutdown::ShutdownReadWrite);
    ...
    void SocketClient::SetAddressFamily(qor::io::network::sockets::eAddressFamily family)
    {
