...
namespace qor{ namespace io { namespace network{ namespace components{
    ...
    SocketConnector::SocketConnector(
        ...
        ref_of<qor::io::async::AsyncIOContext::Session>::type session
        ) : SocketConnector()
    {
    ...
    bool SocketConnector::AttemptConnections(ref_of<qor::io::network::Sockets>::type socketsSubsystem, std::vector<network::AddressInfo>& addresses)
    {
        for(auto address : addresses)
        {
            ...
            m_Socket = socketsSubsystem->CreateSocket(address.family, address.socktype, address.protocol, ref_of<qor::io::async::AsyncIOContext::Session>::type());
