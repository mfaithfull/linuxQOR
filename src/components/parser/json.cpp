                ...
                new Optional(parser,
                    new Sequence(parser,
                        ...
                        new ZeroOrMore(parser,
                            new Sequence(parser,
                                new value_separator(parser),
                                new member(parser))))),
                new end_object(parser)),
        ...
        AnyOneOf(parser,
            ...
            new AnyOneOf(parser,
                ...
                new AnyOneOf(parser,
                    new _true(parser),
                    new AnyOneOf(parser,
                        new deferred<object>(parser),
                        new AnyOneOf(parser,
                            new deferred<array>(parser),
                            new AnyOneOf(parser,
                                new number(parser),
                                new string(parser)))))),
