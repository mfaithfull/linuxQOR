...
#ifndef QOR_PP_H_COMPONENTS_QOR_THREADMEMORY_SMALLOBJECTSOURCE
#define QOR_PP_H_COMPONENTS_QOR_THREADMEMORY_SMALLOBJECTSOURCE
...
namespace qor{ namespace components{ namespace threadmemory{
    ...
    class qor_pp_module_interface(QOR_THREADMEMORY) SmallObjectSource final
    {
    public:
...
#endif//QOR_PP_H_COMPONENTS_QOR_THREADMEMORY_SMALLOBJECTSOURCE
