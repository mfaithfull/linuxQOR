...
#ifndef QOR_PP_H_COMPONENTS_SERIAL_CONTEXT
#define QOR_PP_H_COMPONENTS_SERIAL_CONTEXT
...
namespace qor { namespace components { namespace serial {
    ...
    class qor_pp_module_interface(QOR_SERIAL) Context
    {
    public:
...
#endif //QOR_PP_H_COMPONENTS_SERIAL_CONTEXT
