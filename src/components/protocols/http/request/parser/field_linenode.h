...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_FIELD_LINENODE
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public:
        ...
        virtual ~FieldLineNode() = default;

    };

}}}}

#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_FIELD_LINENODE