...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ORIGIN_FORMNODE
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ORIGIN_FORMNODE
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    struct UriOriginForm
    {
        UriAbsolutePath m_path;
        Query m_query;
    };
    ...
    public:
        ...
        virtual ~UriOriginFormNode() = default;

    };

}}}}

#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ORIGIN_FORMNODE