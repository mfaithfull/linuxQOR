...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: field_content(qor::components::parser::Parser* parser) :
                qor::components::parser::Sequence(parser,
                    ...
                    static_cast<uint64_t>(httpRequestToken::field_content)
                )
        {}
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_FIELD_CONTENTTOKEN