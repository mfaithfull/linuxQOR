...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ASTERISK_FORMNODE
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ASTERISK_FORMNODE
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public:
        ...
        virtual ~UriAsteriskFormNode() = default;

    };

}}}}

#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ASTERISK_FORMNODE