...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    class qor_pp_module_interface(QOR_HTTP) HttpServiceFilter : public qor::pipeline::InlineFilter<byte>
    {
        HttpServiceFilter() : qor::pipeline::InlineFilter<byte>()
        {}

        virtual ~HttpServiceFilter(){}

        virtual void Filter(byte* space, byte* data, size_t& itemCount);
