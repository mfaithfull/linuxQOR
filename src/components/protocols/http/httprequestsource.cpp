...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    HttpRequestSource::HttpRequestSource() : qor::pipeline::Source()
    {
        m_data = "";
        m_it = m_data.begin();
    }

    void HttpRequestSource::SetData(const std::string& data)
    {
        m_data = data;
        m_it = m_data.begin();
    }
    ...
    bool HttpRequestSource::Pull(size_t& unitsRead, size_t unitsToRead)
    {
