...
#include "uri_absolute_pathnode.h"
...
namespace qor { namespace components { namespace protocols { namespace http {
        ...
        //"/" [ segment-nz *( "/" segment ) ]
    class qor_pp_module_interface(QOR_HTTP) uri_absolute_path : public qor::components::parser::Sequence
    {
    public: uri_absolute_path(qor::components::parser::Parser* parser) :
                qor::components::parser::Sequence(parser,
                    ...
                    static_cast<uint64_t>(httpRequestToken::uri_absolute_path)
                )
        {}

        virtual ~uri_absolute_path() = default;
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ABSOLUTE_PATHTOKEN