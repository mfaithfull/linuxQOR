...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_SCHEMETOKEN
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_SCHEMETOKEN
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: scheme(parser::Parser* parser) : 
                components::parser::Sequence(parser,
                    ...
                    static_cast<uint64_t>(httpRequestToken::scheme)
                )
        {}
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_SCHEMETOKEN