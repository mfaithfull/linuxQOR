...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ABSOLUTE_FORMTOKEN
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ABSOLUTE_FORMTOKEN
...
#include "../tokendefs.h"
#include "../nodes/uri_absolute_formnode.h"
#include "schemetoken.h"
#include "heir_parttoken.h"
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: uri_absolute_form(qor::components::parser::Parser* parser) :
                qor::components::parser::Sequence(parser,
                    ...
                    static_cast<uint64_t>(httpRequestToken::uri_absolute_form)
                )
        {}

        virtual ~uri_absolute_form() = default;
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_ABSOLUTE_FORMTOKEN