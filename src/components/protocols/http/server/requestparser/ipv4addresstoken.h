...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_IPV4ADDRESSTOKEN
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_IPV4ADDRESSTOKEN
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: IPv4address(qor::components::parser::Parser* parser) :
                qor::components::parser::Sequence(parser,
                    ...
                    static_cast<uint64_t>(httpRequestToken::IPv4address)
                )
        {}
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_IPV4ADDRESSTOKEN