...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_REG_NAMETOKEN
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_REG_NAMETOKEN
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: reg_name(qor::components::parser::Parser* parser) :
                qor::components::parser::ZeroOrMore(parser,
                    ...
                    static_cast<uint64_t>(httpRequestToken::reg_name)
                )
        {}

        virtual ~reg_name() = default;
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_REG_NAMETOKEN