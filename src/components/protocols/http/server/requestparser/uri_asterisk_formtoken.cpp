...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    void uri_asterisk_form::Prepare()
    {
        std::cout << "Looking for a uri_asterisk_form." << std::endl;
        GetParser()->PushNode(new_ref<UriAsteriskFormNode>());
    }

    void uri_asterisk_form::Emit()
    {
        std::cout << "Emitting a uri_asterisk_form." << std::endl;
