...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    {
    public: protocol_version(parser::Parser* parser) : parser::OneOrMore(parser,
                    new_ref<tchar>(parser),
                    static_cast<uint64_t>(httpRequestToken::protocol_version)
                )
        {}
        virtual ~protocol_version() = default;
        virtual void Prepare();
        virtual void Emit();
        virtual void Fail();
    };
    ...
    {
    public: method(parser::Parser* parser) : parser::OneOrMore(parser,
                    new_ref<tchar>(parser),
