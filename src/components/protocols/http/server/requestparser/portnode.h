...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_PORTNODE
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_PORTNODE
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public:
        ...
        virtual ~PortNode() = default;
    };

}}}}

#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_PORTNODE
