...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_AUTHORITY_FORMNODE
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_AUTHORITY_FORMNODE
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public:
        ...
        virtual ~UriAuthorityFormNode() = default;

    };

}}}}

#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_URI_AUTHORITY_FORMNODE