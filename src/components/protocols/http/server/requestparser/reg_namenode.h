...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_REG_NAMENODE
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_REG_NAMENODE
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public:
        ...
        virtual ~RegNameNode() = default;

    };

}}}}

#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_REG_NAMENODE
