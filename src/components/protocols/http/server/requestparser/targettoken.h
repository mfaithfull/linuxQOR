...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_TARGETTOKEN
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_TARGETTOKEN
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: target(qor::components::parser::Parser* parser) :
                ...
                new std::vector<ref_of<ParserState>::type>({{
                    ...
                    new_ref< uri_authority_form>(parser),
                    new_ref< uri_asterisk_form>(parser),
                    }}),
                    static_cast<uint64_t>(httpRequestToken::target)
                )
        {}
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_TARGETTOKEN