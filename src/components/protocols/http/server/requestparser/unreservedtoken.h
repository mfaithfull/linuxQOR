...
#ifndef QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_UNRESERVEDTOKEN
#define QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_UNRESERVEDTOKEN
...
namespace qor { namespace components { namespace protocols { namespace http {
    ...
    public: unreserved(qor::data::Parser* parser) :
                ...
                new std::vector<ref_of<ParserState>::type>({{
                    ...
                    new_ref< qor::data::parser::Specific<uint32_t>>(parser, '.'),
                    new_ref< qor::data::parser::Specific<uint32_t>>(parser, '_'),
                    new_ref< qor::data::parser::Specific<uint32_t>>(parser, '~'),
                    new_ref< qor::data::parser::ALPHA<uint32_t>>(parser),
...
#endif//QOR_PP_H_COMPONENTS_PROTOCOLS_HTTP_REQUESTPARSER_UNRESERVEDTOKEN