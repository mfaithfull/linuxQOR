...
#ifndef QOR_PP_H_COMPONENTS_FRAMEWORK_UI_LAYOUT_SIZE
#define QOR_PP_H_COMPONENTS_FRAMEWORK_UI_LAYOUT_SIZE
...
#endif//QOR_PP_H_COMPONENTS_FRAMEWORK_UI_LAYOUT_SIZE
