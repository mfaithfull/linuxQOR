...
namespace 
{
    ...
    using WBP = qor::components::tui::WordBreakProperty;
    ...
    {
        if (qor::components::tui::IsControl(ucs)) 
        {
            return -1;
        }

        if (qor::components::tui::IsCombining(ucs)) 
        {
            return 0;
        }

        if (qor::components::tui::IsFullWidth(ucs)) 
        {
            return 2;
        }
