...
namespace qor{ namespace components{ namespace tui {
    ...
    //An event corresponding to a given typed character input sequence sent by the terminal.
    ...
    Event Event::CursorShape(std::string_view input, int shape) 
    {
        ...
        event.data_.cursor_shape = shape;
        return event;
    }

    //A custom event whose meaning is defined by the user of the library.
    // static
    ...
    std::string Event::DebugString() const 
    {
        ...
        switch (type_) 
        {
            ...
            return "Event::CursorShape(" + input_ + ", " + std::to_string(data_.cursor_shape) + ")";
            case Type::CursorPosition:
            return "Event::CursorPosition(" + input_ + ", " + std::to_string(data_.cursor.x) + ", " + std::to_string(data_.cursor.y) + ")";
            default: 
            {
