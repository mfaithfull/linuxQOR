    ...
    namespace flexboxhelper
    {
        namespace 
        {
            ...
            void SetX(Global& global) 
            {
                ...
                {
                    std::vector<boxhelper::Element> elements;
                    elements.reserve(line.blocks.size());
                    for (auto* block : line.blocks) 
                    {
                        boxhelper::Element element;
                    ...
                    boxhelper::Compute(&elements, global.size_x - global.config.gap_x * (int(line.blocks.size()) - 1));
            ...
            void SetY(Global& g) 
            {
                ...
                boxhelper::Compute(&elements, 10000);
