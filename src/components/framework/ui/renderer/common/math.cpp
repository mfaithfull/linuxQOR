...
#define BEZIER_EPSILON 1e-2f
        ...
        while (cmdsCnt-- > 0) {
            switch (*cmds) {
                case PathCommand::Close: {
                    length += qor::components::ui::renderer::length(*(pts - 1), *start);
                    break;
                }
                ...
                case PathCommand::LineTo: {
                    length += qor::components::ui::renderer::length(*(pts - 1), *pts);
                    ++pts;
                    break;
                }
    ...
    {
        if (!equal(lhs.e11, rhs.e11) || !equal(lhs.e12, rhs.e12) || !equal(lhs.e13, rhs.e13) ||
    ...
    Bezier::Bezier(const Point& st, const Point& ed, float radius)
    {
        ...
        auto angle = atan2(ed.y - st.y, ed.x - st.x);
