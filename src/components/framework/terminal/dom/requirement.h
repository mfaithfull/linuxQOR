...
#ifndef QOR_PP_H_COMPONENTS_FRAMEWORK_TUI_DOM_REQUIREMENT
#define QOR_PP_H_COMPONENTS_FRAMEWORK_TUI_DOM_REQUIREMENT
...
namespace qor{ namespace components{ namespace tui {
    ...
    struct qor_pp_module_interface(QOR_TUI) Requirement 
    {
...
#endif//QOR_PP_H_COMPONENTS_FRAMEWORK_TUI_DOM_REQUIREMENT
