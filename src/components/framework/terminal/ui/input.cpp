...
#include "../screen/stringinternal.h"
#include "../util/util.h"
...
namespace qor{ namespace components{ namespace tui {
    ...
    namespace 
    {
        ...
        class qor_pp_module_interface(QOR_TUI) InputBase : public ComponentBase, public InputOption 
        {
        public:
        ...
        private:
            ...
            Element OnRender() override 
            {
                ...
                const auto focused = (!is_focused && !hovered_) ? nothing : insert() ? focusCursorBarBlinking : focusCursorBlockBlinking;
                ...
                for (size_t i = 0; i < lines.size(); ++i) 
                {
                    ...
                    const std::string part_at_cursor = line.substr(glyph_start, glyph_end - glyph_start);
            ...
            bool HandleArrowLeft() 
            {
                ...
                cursor_position() = static_cast<int>(GlyphPrevious(content(), cursor_position()));
                return true;
            }
            ...
            bool HandleArrowRight() 
            {
                ...
                cursor_position() = static_cast<int>(GlyphNext(content(), cursor_position()));
                return true;
            }
            ...
            {
                if (!insert() && cursor_position() < (int)content->size() && content()[cursor_position()] != '\n') 
                {
                    DeleteImpl();
                }
