...
{
#if CPPCORO_OS_WINNT
	detail::win32::safe_handle create_io_completion_port(std::uint32_t concurrencyHint)
	{
		...
		return detail::win32::safe_handle{ handle };
	}

	detail::win32::safe_handle create_auto_reset_event()
	{
		...
		return detail::win32::safe_handle{ eventHandle };
	}

	detail::win32::safe_handle create_waitable_timer_event()
	{
...
detail::win32::handle_t io_service::native_iocp_handle() noexcept
{
...
void io_service::ensure_winsock_initialised()
{
