...
#ifndef QOR_PP_H_DATA_JSON_PARSER_NODES_ESCAPESEQUENCE
#define QOR_PP_H_DATA_JSON_PARSER_NODES_ESCAPESEQUENCE
...
#endif//QOR_PP_H_DATA_JSON_PARSER_NODES_ESCAPESEQUENCE