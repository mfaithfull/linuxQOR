...
#ifndef QOR_PP_H_DATA_JSON_PARSER_NODES_UNICODESEQUENCE
#define QOR_PP_H_DATA_JSON_PARSER_NODES_UNICODESEQUENCE
...
#endif//QOR_PP_H_DATA_JSON_PARSER_NODES_UNICODESEQUENCE