...
#ifndef QOR_PP_H_COMPONENTS_NETWORK_CLIENTS_HTTP_TEXT
#define QOR_PP_H_COMPONENTS_NETWORK_CLIENTS_HTTP_TEXT
...
namespace qor{ namespace components{ namespace network{ namespace text {
...
#endif//QOR_PP_H_COMPONENTS_NETWORK_CLIENTS_HTTP_TEXT
