...
bool net::socket_recv_from_operation_impl::try_start(
...
void net::socket_recv_from_operation_impl::cancel(
	detail::win32_overlapped_operation_base& operation) noexcept
{
	(void)::CancelIoEx(
...
std::tuple<std::size_t, net::ip_endpoint>
net::socket_recv_from_operation_impl::get_result(
