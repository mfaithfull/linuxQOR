...
namespace
{
	namespace local
	{
			...
			HANDLE ioCompletionPort)
		{
			...
			auto closeSocketOnFailure = on_scope_failure([&]
			{
...
net::socket net::socket::create_tcpv4(io_service& ioSvc)
{
...
net::socket net::socket::create_tcpv6(io_service& ioSvc)
{
	ioSvc.ensure_winsock_initialised();
...
net::socket net::socket::create_udpv4(io_service& ioSvc)
{
	ioSvc.ensure_winsock_initialised();
...
net::socket net::socket::create_udpv6(io_service& ioSvc)
{
	ioSvc.ensure_winsock_initialised();
...
net::socket&
net::socket::operator=(socket&& other) noexcept
{
...
void net::socket::bind(const ip_endpoint& localEndPoint)
{
	...
	if (result == 0)
	{
		m_localEndPoint = net::detail::sockaddr_to_ip_endpoint(*sockaddr);
	}
	else
	{
...
void net::socket::listen(std::uint32_t backlog)
{
...
net::socket_accept_operation
net::socket::accept(socket& acceptingSocket) noexcept
{
	return socket_accept_operation{ *this, acceptingSocket };
}

net::socket_accept_operation_cancellable
net::socket::accept(socket& acceptingSocket, CancellationToken ct) noexcept
{
	return socket_accept_operation_cancellable{ *this, acceptingSocket, std::move(ct) };
}

net::socket_connect_operation
net::socket::connect(const ip_endpoint& remoteEndPoint) noexcept
{
	return socket_connect_operation{ *this, remoteEndPoint };
}

net::socket_connect_operation_cancellable
net::socket::connect(const ip_endpoint& remoteEndPoint, CancellationToken ct) noexcept
{
	return socket_connect_operation_cancellable{ *this, remoteEndPoint, std::move(ct) };
}

net::socket_disconnect_operation
net::socket::disconnect() noexcept
{
	return socket_disconnect_operation(*this);
}

net::socket_disconnect_operation_cancellable
net::socket::disconnect(CancellationToken ct) noexcept
{
	return socket_disconnect_operation_cancellable{ *this, std::move(ct) };
}

net::socket_send_operation
net::socket::send(const void* buffer, std::size_t byteCount) noexcept
{
	return socket_send_operation{ *this, buffer, byteCount };
}

net::socket_send_operation_cancellable
net::socket::send(const void* buffer, std::size_t byteCount, CancellationToken ct) noexcept
{
	return socket_send_operation_cancellable{ *this, buffer, byteCount, std::move(ct) };
}

net::socket_recv_operation
net::socket::recv(void* buffer, std::size_t byteCount) noexcept
{
	return socket_recv_operation{ *this, buffer, byteCount };
}

net::socket_recv_operation_cancellable
net::socket::recv(void* buffer, std::size_t byteCount, CancellationToken ct) noexcept
{
	return socket_recv_operation_cancellable{ *this, buffer, byteCount, std::move(ct) };
}

net::socket_recv_from_operation
net::socket::recv_from(void* buffer, std::size_t byteCount) noexcept
{
	return socket_recv_from_operation{ *this, buffer, byteCount };
}

net::socket_recv_from_operation_cancellable
net::socket::recv_from(void* buffer, std::size_t byteCount, CancellationToken ct) noexcept
{
	return socket_recv_from_operation_cancellable{ *this, buffer, byteCount, std::move(ct) };
}

net::socket_send_to_operation
net::socket::send_to(const ip_endpoint& destination, const void* buffer, std::size_t byteCount) noexcept
{
	return socket_send_to_operation{ *this, destination, buffer, byteCount };
}

net::socket_send_to_operation_cancellable
net::socket::send_to(const ip_endpoint& destination, const void* buffer, std::size_t byteCount, CancellationToken ct) noexcept
{
	return socket_send_to_operation_cancellable{ *this, destination, buffer, byteCount, std::move(ct) };
}

void net::socket::close_send()
{
