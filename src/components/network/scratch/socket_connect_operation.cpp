...
bool net::socket_connect_operation_impl::try_start(
	detail::win32_overlapped_operation_base& operation) noexcept
{
	...
	const int sockaddrNameLength = net::detail::ip_endpoint_to_sockaddr(
		m_remoteEndPoint,
...
void net::socket_connect_operation_impl::cancel(
	detail::win32_overlapped_operation_base& operation) noexcept
{
	(void)::CancelIoEx(
...
void net::socket_connect_operation_impl::get_result(
	detail::win32_overlapped_operation_base& operation)
{
...

	{
		...
		if (result == 0)
		{
			m_socket.m_localEndPoint = net::detail::sockaddr_to_ip_endpoint(
...

	{
		...
		if (result == 0)
		{
			m_socket.m_remoteEndPoint = net::detail::sockaddr_to_ip_endpoint(
