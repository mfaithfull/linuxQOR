...
namespace cppcoro
{
	...
	namespace net
	{
		...
		public:
			...
			detail::win32::socket_t native_handle() noexcept { return m_handle; }
			...
			/// cancelled then it will complete by throwing a operation_cancelled
			/// exception.
			///
			/// \return
			...
			[[nodiscard]]
			socket_disconnect_operation_cancellable disconnect(CancellationToken ct) noexcept;
...
#if CPPCORO_OS_WINNT
			detail::win32::socket_t m_handle;
