...
# pragma warning(pop)
		...
		class socket_accept_operation
			: public detail::win32_overlapped_operation<socket_accept_operation>
		{
		public:
		...
		private:
			...
			friend class detail::win32_overlapped_operation<socket_accept_operation>;
		...
		class socket_accept_operation_cancellable
			: public detail::win32_overlapped_operation_cancellable<socket_accept_operation_cancellable>
		{
		public:
			...
			socket_accept_operation_cancellable(
				...
				: detail::win32_overlapped_operation_cancellable<socket_accept_operation_cancellable>(std::move(ct))
				, m_impl(listeningSocket, acceptingSocket)
			{}

		private:

			friend class detail::win32_overlapped_operation_cancellable<socket_accept_operation_cancellable>;
