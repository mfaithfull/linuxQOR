...
#ifndef QOR_PP_H_FRAMEWORK_UI_TERMINAL_RENDERER_COLOUR
#define QOR_PP_H_FRAMEWORK_UI_TERMINAL_RENDERER_COLOUR
...
namespace qor{ namespace ui{ namespace tty {
    ...
    public:
        ...
        Colour();                  // Transparent.
        Colour(Palette1 index);    // Transparent.
        Colour(Palette16 index);   // Implicit conversion from index to Colour.
        Colour(Palette256 index);  // Implicit conversion from index to Colour.
        ...
        static Colour RGBA(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha);
        static Colour HSVA(uint8_t hue, uint8_t saturation, uint8_t value, uint8_t alpha);
        static Colour Interpolate(float t, const Colour& a, const Colour& b);
        static Colour Blend(const Colour& lhs, const Colour& rhs);
    ...
    private:
        ...
        ColourType type_ = ColourType::Palette1;
        uint8_t red_ = 0;
        uint8_t green_ = 0;
        uint8_t blue_ = 0;
        uint8_t alpha_ = 0;
    ...
    {
        //Creates a colour from a combined hex RGB representation,
        // e.g. 0x808000_rgb
...
#endif//QOR_PP_H_FRAMEWORK_UI_TERMINAL_RENDERER_COLOUR
