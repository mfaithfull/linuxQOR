...
We centralise the aqusition of external resources and shunt it to a background task which works through the process of resource discovery, unique identification, classification and parsing to validated in memory objects where possible.
