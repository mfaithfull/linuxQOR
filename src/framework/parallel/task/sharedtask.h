...
#ifndef QOR_PP_H_FRAMEWORK_TASK_SHARED_LAZY
#define QOR_PP_H_FRAMEWORK_TASK_SHARED_LAZY
...
namespace qor{
	...
	public:
		...
		// Returns an awaitable that will await completion of the task without attempting to retrieve the result.
...
#endif//QOR_PP_H_FRAMEWORK_TASK_SHARED_LAZY
