...
#ifndef QOR_PP_H_FRAMEWORK_TASK
#define QOR_PP_H_FRAMEWORK_TASK
	...
	namespace detail
	{
		class task_promise_base
		{
			...
			struct final_awaitable
			{
				...
				template<typename PROMISE>
				qor_pp_noinline
				void await_suspend(std::coroutine_handle<PROMISE> coroutine) noexcept(true)
				{
