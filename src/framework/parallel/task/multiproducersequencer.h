...
#ifndef QOR_PP_H_FRAMEWORK_TASK_MULTI_PRODUCER_SEQUENCER
#define QOR_PP_H_FRAMEWORK_TASK_MULTI_PRODUCER_SEQUENCER
...
#endif//QOR_PP_H_FRAMEWORK_TASK_MULTI_PRODUCER_SEQUENCER
