...
//# include <configuration/preprocessor/punctuation/paren_if.hpp>
//# include <configuration/preprocessor/punctuation/remove_parens.hpp>
#
# endif//QOR_PREPROCESSOR_PUNCTUATION_HPP
