...
extern "C"
{
	...
	{
		static qor::Module QORModule("Querysoft Open Runtime: Windows EGL Module", 
		...
		static qor::TypeRegEntry< qor::platform::nswindows::EGL, qor::components::EGLFeature > regEGL;
		return QORModule;
	}
}
