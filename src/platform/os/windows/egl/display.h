...
#ifndef QOR_PP_H_WINDOWS_EGL_DISPLAY
#define QOR_PP_H_WINDOWS_EGL_DISPLAY
...
namespace qor{ namespace platform { namespace nswindows{ 
    ...
    class qor_pp_module_interface(QOR_WINEGL) EglWindow;

    class qor_pp_module_interface(QOR_WINEGL) EglDisplay : public qor::components::EGLDisplay
    {
    public:
    ...
    private:
        ...
        int32_t m_minor;
        void* m_display;
        EglWindow* m_nativeWindow;
    };

}}}//qor::platform::nswindows

#endif//QOR_PP_H_WINDOWS_EGL_DISPLAY