...
#ifndef QOR_PP_H_WINDOWS_OPENGLES
#define QOR_PP_H_WINDOWS_OPENGLES
...
namespace qor{ bool qor_pp_module_interface(QOR_WINEGL) ImplementsOpenGLESFeature(); }

//All types on this interface must be portable
namespace qor{ namespace platform { namespace nswindows{ 
    
    class qor_pp_module_interface(QOR_WINOPENGLES) OpenGLES : public qor::components::OpenGLESFeature
    {
    public:
...
#endif//QOR_PP_H_WINDOWS_OPENGLES
