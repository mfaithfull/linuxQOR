...
extern "C"
{
	...
	{
		static qor::Module QORModule("Querysoft Open Runtime: Windows OpenGLES Module", 
		...
		static qor::TypeRegEntry< qor::platform::nswindows::OpenGLES, qor::components::OpenGLESFeature > regOpenGLES;
		return QORModule;
	}
}
