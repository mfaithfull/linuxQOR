...
namespace qor{ namespace async{ namespace win{
    ...
    class qor_pp_module_interface(QOR_WINDOWSASYNCIOSERVICE) AsyncIOService : public qor::io::async::AsyncIOService
    {
    public:
