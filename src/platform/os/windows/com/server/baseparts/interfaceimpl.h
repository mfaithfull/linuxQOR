...
#ifndef QOR_PP_H_WINDOWS_COM_SERVER_BASE_INTERFACEIMPL
#define QOR_PP_H_WINDOWS_COM_SERVER_BASE_INTERFACEIMPL
...
namespace qor{ namespace platform { namespace win{
    ...
    public:
        ...
        InterfaceImplBase(IUnknownImplBase<>* pImpl) : TBase(pImpl)
        {
            TBase::RegisterInterface(dynamic_cast<TInterface*>(this));
        }
