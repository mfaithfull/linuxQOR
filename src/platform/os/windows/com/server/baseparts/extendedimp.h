...
#ifndef QOR_PP_H_WINDOWS_COM_SERVER_BASE_EXTENDEDIMP
#define QOR_PP_H_WINDOWS_COM_SERVER_BASE_EXTENDEDIMP
...
namespace qor{ namespace platform { namespace nswindows{
    ...
    public:
        ...
        ExtendedImp(IUnknownImplBase<>* pImpl) : TBaseImpl(pImpl)
        {
        }
