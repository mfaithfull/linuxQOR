...
namespace qor { namespace win { namespace api {
	...
	public:
		...
		static HRESULT AllocConsoleWithOptions( PALLOC_CONSOLE_OPTIONS allocOptions, PALLOC_CONSOLE_RESULT result);
		static BOOL AttachConsole(DWORD dwProcessId);
		static void ClosePseudoConsole(HPCON hPC);
		...
		static HRESULT CreatePseudoConsole(COORD size, HANDLE hInput, HANDLE hOutput, DWORD dwFlags, HPCON* phPC);
		...
		static BOOL ReadConsoleInputEx(HANDLE hConsoleInput, ::PINPUT_RECORD lpBuffer, DWORD nLength, LPDWORD lpNumberOfEventsRead, USHORT wFlags);
		...
		static HRESULT ReleasePseudoConsole(HPCON hPC);
		static HRESULT ResizePseudoConsole(HPCON hPC, COORD size);
