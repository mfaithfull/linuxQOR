...
namespace qor{ namespace network { namespace nswindows{
    ...
    public:
        ...
        virtual ref_of<network::Socket>::type CreateSocket(const network::sockets::eAddressFamily AF, const network::sockets::eType Type, const network::sockets::eProtocol Protocol, ref_of<qor::async::AsyncIOContext::Session>::type ioSession) const;        
