...
#ifndef QOR_PP_H_WIN_UI_TERMINAL_PIXEL
#define QOR_PP_H_WIN_UI_TERMINAL_PIXEL
...
namespace qor{ namespace ui{ namespace tui { namespace win{
    ...
    struct Pixel 
    {
        ...
        // It's an index for accessing Terminal meta data
        uint8_t hyperlink = 0;
...
#endif//QOR_PP_H_WIN_UI_TERMINAL_PIXEL