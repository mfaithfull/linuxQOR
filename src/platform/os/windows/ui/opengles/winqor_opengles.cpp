...
extern "C"
{
	...
	{
		static qor::Module QORModule("Querysoft Open Runtime: Windows OpenGLES Module", qor_pp_module_ver_string );

		//Register the Windows specific implementations
		static qor::TypeRegEntry< qor::win::OpenGLES, qor::components::OpenGLESFeature > regOpenGLES;
		return QORModule;
	}
}
