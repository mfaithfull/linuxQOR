...
namespace qor{ namespace platform { namespace win{ 
    ...
    public:
        ...
        void SetHandler(qor::ref_of<qor::platform::win::gui::view::AbstractWindowHandler>::type handler);
        qor::ref_of<qor::platform::win::gui::view::AbstractWindowHandler>::type GetHandler();

        void SetLayout(qor::ref_of<qor::platform::win::gui::view::LayoutItem>::type layout);
        qor::ref_of<qor::platform::win::gui::view::LayoutItem>::type GetLayout();
    ...
    protected:
        ...
        qor::ref_of<qor::platform::win::gui::view::AbstractWindowHandler>::type m_handler;
        qor::ref_of<qor::platform::win::gui::view::LayoutItem>::type m_layout;
