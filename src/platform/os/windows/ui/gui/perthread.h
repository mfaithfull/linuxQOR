...
namespace qor{ qor_pp_declare_instancer_of(qor::platform::win::PerThread, ThreadSingletonInstancer);}

qor_pp_export extern qor::detail::ThreadInstanceHolder<qor::platform::win::PerThread>* GetCurrentPerThread();
