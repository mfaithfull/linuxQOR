...
namespace qor{ namespace platform { namespace win{ namespace gui{ namespace view{
    ...
    bool WinCtrlParentHandler::ProcessMessage(Window& window, long long& lResult, unsigned int msg, unsigned long long wParam, long long lParam)
    {
    ...
    long WinCtrlParentHandler::OnCompareItem(Window& window, unsigned long long wParam, ComparisonItem* itemStruct)
    {
    ...
    void WinCtrlParentHandler::OnMeasureItem(Window& window, unsigned long long wParam, MeasureItemStruct* itemStruct)
    {
        if (itemStruct != nullptr)
        {
            /*
    ...
    void WinCtrlParentHandler::OnDeleteItem(Window& window, unsigned long long wParam, DeleteItemStruct* itemStruct)
    {     
        if (itemStruct != nullptr)
        {
            Window childWindow(PrimitiveHandle(itemStruct->phwndItem));
    ...
    long WinCtrlParentHandler::OnVKeyToItem(Window& window, unsigned short wVKey, unsigned short wPos, Window& listBox)
    {     
        long lResult = 0;
        /*
    ...
    long WinCtrlParentHandler::OnCharToItem(Window& window, unsigned short wKey, unsigned short wPos, Window& listBox)
    {
        long lResult = 0;
        /*
        CWinCtrlWindow* pCtrlWindow = dynamic_cast<CWinCtrlWindow*>(ListBox.operator COSWindow *());
