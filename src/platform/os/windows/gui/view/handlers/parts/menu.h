...
namespace qor{ namespace platform { namespace nswindows{ namespace gui{ namespace view{
    ...
    public:
        ...
        virtual bool OnMenuSelect(Window& Wnd, Menu& hMenu, unsigned short wIndex, unsigned short wFlags);
        ...
        virtual bool OnCommand(Window& Wnd, unsigned short code, unsigned short id, long long handle);
