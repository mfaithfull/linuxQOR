...
#ifndef QOR_PP_H_WINDOWS_GUI_VIEW_CONTROLLER_RENDERED_TEXT
#define QOR_PP_H_WINDOWS_GUI_VIEW_CONTROLLER_RENDERED_TEXT
...
namespace qor{ namespace platform { namespace nswindows{ namespace gui{ namespace view{
    ...
    class qor_pp_module_interface(QOR_WINGUI) TextController : public BaseWindowPartController
    {
    public:

        TextController();
        virtual ~TextController() = default;
...
#endif//QOR_PP_H_WINDOWS_GUI_VIEW_CONTROLLER_RENDERED_TEXT