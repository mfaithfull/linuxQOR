...
namespace qor{ namespace platform { namespace nswindows{ namespace gui{ namespace view{
    ...
    TextController::TextController() : BaseWindowPartController()
    {
    }

    bool TextController::ProcessMessage(Window& window, long long& lResult, unsigned int msg, unsigned long long wParam, long long lParam)
    {
    ...
    void TextController::OnSetFont(Window& window, Font font, bool bRedraw)
    {
    }

    PrimitiveHandle TextController::OnGetFont(Window& window)
    {
