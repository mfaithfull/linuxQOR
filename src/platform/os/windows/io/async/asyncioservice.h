...
qor_pp_module_will_provide(QOR_WINDOWSASYNCIOSERVICE, Service)
qor_pp_module_will_provide(QOR_WINDOWSASYNCIOSERVICE, EventProcessor)
qor_pp_module_will_provide(QOR_WINDOWSASYNCIOSERVICE, Initiator)
