...
extern "C"
{
	qor::Module& ThisModule(void)
	{
		...
		static qor::TypeRegEntry< qor::network::win::Sockets, qor::network::Sockets > regSockets;
		static qor::TypeRegEntryWithParams< qor::network::win::Socket, qor::network::Socket, qor::network::sockets::eAddressFamily&, qor::network::sockets::eType&, qor::network::sockets::eProtocol& > regSocket;
		return QORModule;
	}
}
