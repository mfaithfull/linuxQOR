...
extern "C"
{
	qor::Module& ThisModule(void)
	{
		...
		static qor::TypeRegEntry< qor::async::lin::IOUringEventProcessor, qor::async::AsyncIOEventProcessor > regAsyncIOEventProcessor;
		static qor::TypeRegEntry< qor::async::lin::IOUringInitiator, qor::async::AsyncIOInitiator > regAsyncIOInitiator;
		return QORModule;
	}
}
