...
extern "C"
{
	...
	{
		static qor::Module QORModule("Querysoft Open Runtime: Linux Cairo Module", qor_pp_module_ver_string );

		//Register the Linux specific implementations
		static qor::TypeRegEntry< qor::ui::lin::Cairo, qor::components::CairoFeature > regCairo;
		return QORModule;
	}
}
