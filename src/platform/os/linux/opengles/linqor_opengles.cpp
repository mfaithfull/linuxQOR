...
{
	static qor::Module QORModule("Querysoft Open Runtime: Linux OpenGLES",
		qor_pp_stringize(qor_pp_ver_major) "." qor_pp_stringize(qor_pp_ver_minor) "." qor_pp_stringize(qor_pp_ver_patch) "." __DATE__ "_" __TIME__);

    //Register the Windows specific implementations
	static qor::TypeRegEntry< qor::platform::nslinux::OpenGLES, qor::components::OpenGLESFeature > regOpenGLES;
	return QORModule;
}
