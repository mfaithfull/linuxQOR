...
extern "C"
{
	...
	{
		static qor::Module QORModule("Querysoft Open Runtime: Linux Sockets Module", 
		...
		static qor::TypeRegEntry< qor::lin::Sockets, qor::network::Sockets > regSockets;
		static qor::TypeRegEntryWithParams< qor::lin::Socket, qor::network::Socket, qor::network::sockets::eAddressFamily&, qor::network::sockets::eType&, qor::network::sockets::eProtocol& > regSocket;
		return QORModule;
	}
}
