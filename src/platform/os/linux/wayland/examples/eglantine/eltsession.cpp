...
eltSession::eltSession(qor::ref_of<qor::components::OpenGLESFeature>::type opengles, 
    qor::ref_of<qor::components::EGLFeature>::type egl, qor::ref_of<qor::components::EGLDisplay>::type display) : qor::platform::nslinux::wl::XDGSession(display), 
    m_gl(opengles)
{
}
