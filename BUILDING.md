...
You'll need at least CMake 3.10.0 to build the QOR. CMake 4+ is recommended.
...
The Visual Studio 2022 CL compiler (You'll need Visual Studio 2022 Community installed)
...
Once you have your Compiler/Toolchain/IDE/CMake in place try building the '/examples/basic/helloworld' executable
...
Build times should be < 30 mins for everything on a reasonable PC (Github builds in ~26mins at time of writing). 
A clean build of the incomplete HTTPServer example takes ~38s on my unreasonable PC.
