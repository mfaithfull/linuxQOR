...
{
    auto asyncIOService = AppBuilder().TheApplication(qor_shared)->GetRole(qor_shared)->GetFeature<qor::io::async::Service>().AsRef<qor::io::async::Service>();
