...
using namespace qor;
struct FrozenUnorderedStrSetTestSuite{};

qor_pp_test_suite_case(FrozenUnorderedStrSetTestSuite, tripleton) 
{
...
qor_pp_test_suite_case(FrozenUnorderedStrSetTestSuite, _test2) 
{
#define INIT_SEQ                                                               \
