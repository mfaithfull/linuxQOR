...
qor_pp_test_case(iterateOverConstBuffer)
{
    ConstBuffer<char> charBuffer("Lorem Ipsum");
...
qor_pp_test_case(iterateOverEncodedBuffer)
{
    EncodedBuffer<char16_t> utf16Buffer(u"Something fancy");
