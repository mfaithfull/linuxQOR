...
qor_pp_test_suite_case(stdifstreamTestSuite, testCompilesWithqor_stdifstreamsourceLinked)
{    
...
qor_pp_test_suite_case(stdifstreamTestSuite, canSetupstdifstreamsource)
{    
    ByteBuffer buffer(1024);
    NullSink sink;
    stdifstreamConnector connector;
