...
#include "src/components/io/pipeline/sinks/stdofstreamsink/stdofstreamsink.h"
#include "src/components/io/pipeline/sinks/stdofstreamsink/stdofstreamwriter.h"
...
{    
    ...
    fileSystem->Setup();
    io::filesystem::Index file(fileSystem->CurrentPath(), "output.json");
