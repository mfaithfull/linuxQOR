...
#include "src/framework/data/contract/adapters/binary.h"
#include "src/framework/data/contract/check.h"
#include "src/framework/data/contract/contract.h"
#include "src/framework/data/contract/security.h"
...
namespace adapter_traits_tests {
    ...
    struct log_adapter 
    {
        ...
        using visible_vocabularies = contract::vocabularies<schema_vocabulary,security_vocabulary>;
    };

    struct audit_adapter 
    {
        static constexpr contract::adapter_type type = contract::adapter_type::debug;
        static constexpr contract::attribute_visibility visibility = contract::attribute_visibility::all_attrs_read_only;
    };

}//adapter_traits_tests
...
qor_pp_test_case(adapter_traits_test) 
{
    ...
    static_assert(contract::adapters::binary::adapter_traits::visibility == contract::attribute_visibility::declared_vocabularies_only);
    static_assert(std::is_same_v<
        contract::adapters::binary::adapter_traits::visible_vocabularies,
        contract::vocabularies<contract::check::vocabulary,contract::security::vocabulary>>);
    static_assert(std::is_same_v<
