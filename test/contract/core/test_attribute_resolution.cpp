...
#include "src/framework/data/contract/attributes/resolution.h"
#include "src/framework/data/contract/attributes/validation.h"
...
qor_pp_test_case(attribute_resolution_test) 
{
    using namespace attribute_resolution_tests;
    using contract::attribute_mode;
    using contract::attribute_resolution_kind;

    constexpr auto enforced_result = contract::resolve_attribute_mode<adapter>(enforced{});
    ...
    static_assert(contract::resolve_attribute_mode<adapter>(hinted{}).mode == attribute_mode::hint);
    static_assert(contract::resolve_attribute_mode<adapter>(displayed{}).mode == attribute_mode::display);
    static_assert(contract::resolve_attribute_mode<adapter>(ignored{}).mode == attribute_mode::ignore);
    static_assert(contract::resolve_attribute_mode<adapter>(unsupported{}).mode == attribute_mode::error);

    constexpr auto hidden_result = contract::resolve_attribute_mode<adapter>(hidden{});
    static_assert(hidden_result.kind == attribute_resolution_kind::invisible);

    static_assert(contract::resolve_attribute_mode<audit_adapter>(unsupported{}).mode == attribute_mode::display);
    static_assert(contract::resolve_attribute_mode<audit_adapter>(hidden{}).mode == attribute_mode::display);

    constexpr auto implemented = contract::resolve_attribute_mode<adapter>(render_policy{});
    static_assert(implemented.kind == attribute_resolution_kind::visible);
    static_assert(implemented.mode == attribute_mode::enforce);

    static_assert(contract::resolve_attribute_mode<adapter>(out_of_scope_policy{}).mode == attribute_mode::out_of_scope);
    static_assert(contract::resolve_attribute_mode<adapter>(rejected_policy{}).mode == attribute_mode::reject);

    static_assert(contract::resolve_attribute_mode<storage_adapter>(render_policy{}).mode == attribute_mode::error);
